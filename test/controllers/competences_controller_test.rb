...
class CompetencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competence" do
    assert_difference('Competence.count') do
      post competences_url, params: { competence: { code: @competence.code, membre_id: @competence.membre_id, nom: @competence.nom } }
    end
  ...
  test "should update competence" do
    patch competence_url(@competence), params: { competence: { code: @competence.code, membre_id: @competence.membre_id, nom: @competence.nom } }
