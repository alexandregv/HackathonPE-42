...
class MembresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create membre" do
    assert_difference('Membre.count') do
      post membres_url, params: { membre: { age: @membre.age, mail: @membre.mail, nom: @membre.nom, prenom: @membre.prenom } }
    end
  ...
  test "should update membre" do
    patch membre_url(@membre), params: { membre: { age: @membre.age, mail: @membre.mail, nom: @membre.nom, prenom: @membre.prenom } }
